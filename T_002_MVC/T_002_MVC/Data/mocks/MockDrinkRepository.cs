...
{
    public class MockDrinkRepository : IDrinkRepositorycs
    {
        ...
        public IEnumerable<Drink> Drink => throw new NotImplementedException();

        public IEnumerable<Drink> PrefferedDrinks => throw new NotImplementedException();
